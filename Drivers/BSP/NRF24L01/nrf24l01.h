...
#define NRF24L01_CE_GPIO_CLK_ENABLE()      do{ __HAL_RCC_GPIOA_CLK_ENABLE(); }while(0)   /* PG口时钟使能 */

#define NRF24L01_CSN_GPIO_PORT             GPIOC
#define NRF24L01_CSN_GPIO_PIN              GPIO_PIN_4
#define NRF24L01_CSN_GPIO_CLK_ENABLE()     do{ __HAL_RCC_GPIOC_CLK_ENABLE(); }while(0)   /* PE口时钟使能 */

#define NRF24L01_IRQ_GPIO_PORT             GPIOC
#define NRF24L01_IRQ_GPIO_PIN              GPIO_PIN_5
#define NRF24L01_IRQ_GPIO_CLK_ENABLE()     do{ __HAL_RCC_GPIOC_CLK_ENABLE(); }while(0)   /* PG口时钟使能 */
